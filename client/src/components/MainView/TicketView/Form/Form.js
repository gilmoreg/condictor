  ...
  render() {
    return (
      <form className="Form">
        ...
        <input id="new-ticket-category" type="text" placeholder="Category" list="new-ticket-category-list" />
        ...
        <input id="new-ticket-resource" type="text" placeholder="Resource" list="new-ticket-resource-list" />
